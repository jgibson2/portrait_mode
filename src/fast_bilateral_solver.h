...
// A na�ve implementation of the bilateral solver.
...
public:
	...
	std::optional<cv::Mat> solve(const cv::Mat& initial_image_float, const bilateral_grid_simplified& grid, const std::vector<int>& data_cost_lookup, const int disparity_range, const float lambda, const int max_num_iterations = 25, const int keep_nb_of_intermediate_images = 0);
